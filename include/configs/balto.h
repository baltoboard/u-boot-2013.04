...
#define CONFIG_EXTRA_ENV_SETTINGS \
	"panel=-1\0" \
	"rootdev=/dev/mtdblock0\0" \
	"baseargs=console=ttySC3,115200 init=/init ignore_loglevel\0" \
	...
	"s_boot=run s0 s1 s2 s3 qd; set bootargs ${baseargs} root=${rootdev} panel=${panel}; fdt chosen; bootm go\0" \
	...
	"x2=" \
		...
		"else " \
			...
			"fi; " \
		"fi;\0" \
	"x_boot=run x0 x1 x2 qd; set bootargs ${baseargs} root=${rootdev} panel=${panel}; fdt chosen; bootx 18200000 20500000\0"
